...
import org.openqa.selenium.support.ui.WebDriverWait;
		...
		public class AddCompanyStructure {
		...
		//click on company structure
		  ...
		  Thread.sleep(2000);
		  //create WebElement for Add
		 WebElement objAdd=driver.findElement(By.className("add"));
		 objAdd.click();
		 Thread.sleep(2000);
		...
		// wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.id("rightMenu")));
		 ...
		 if(driver.findElement(By.xpath("//html/body/div[2]/div[1]/div[2]/div/h3")).getText().equals("Add a sub-division to qa planet"))
{
...
//Create WebElement for save
		WebElement objSave=driver.findElement(By.xpath(".//*[@value='Save']"));  
		  String DPTID="1234";
		  String NAME="abcdef";
// Enter Department id,name,type,location and description and click on save	   
		objDepartment.sendKeys(DPTID);       
		objName.sendKeys(NAME);      
		Select Type=new Select(objType);
		Type.selectByVisibleText("Department");
		Select Loc=new Select(objLocation);
		Loc.selectByValue("LOC2389");
		objDescription.sendKeys("Aircraft Maintenanace"); 
		objSave.click();
		Thread.sleep(2000);
		
//Verify Department id and name under Company name tree structure.
	//Get Row Count
...
String strCompanyinfo=driver.findElement(By.xpath("//html/body/div[1]/table/tbody/tr["+k+"]/td[1]/a")).getText();


	System.out.println(strCompanyinfo+" is displayed");
}*/
